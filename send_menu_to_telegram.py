...
# 설정 / Configuration
# -----------------------------------------------------------------------------
# GitHub Secrets를 사용하거나, 직접 토큰을 입력할 수 있습니다.
TELEGRAM_BOT_TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '8647260455:AAHGfo72utqNpwDusFRnCu4cuwmtcqoSStw')
TELEGRAM_CHAT_ID = os.getenv('TELEGRAM_CHAT_ID', '8389712111')
